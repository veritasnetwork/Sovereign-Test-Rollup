...
async function queryState(module: string, path: string): Promise<any> {
  try {
...
function createProgressBar(value: number, width: number = 30): string {
...
async function checkModules(): Promise<boolean> {
  try {
