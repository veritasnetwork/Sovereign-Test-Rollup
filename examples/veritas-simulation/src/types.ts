...
export interface RuntimeCall {
    ...
    revenue_share?:            CallMessage8Class | CallMessage8Enum;
    mailbox?:                  CallMessage9;
    interchain_gas_paymaster?: CallMessage10;
    merkle_tree_hook?:         null;
    warp?:                     CallMessage11;
    value_setter?:             CallMessage12;
    veritas_agent?:            CallMessage13;
    veritas_belief?:           CallMessage14;
    veritas_submission?:       CallMessage15;
}
 ...
 */
export interface CallMessage8Class {
    lower_revenue_percentage?: LowerRevenuePercentage;
    update_sovereign_admin?:   UpdateSovereignAdmin;
    withdraw_rewards?:         WithdrawRewards;
}

export interface LowerRevenuePercentage {
    /**
     * New percentage in basis points (e.g., 1000 = 10%)
     */
    percentage_in_basis_points: number;
    [property: string]: any;
}

export interface UpdateSovereignAdmin {
    /**
 ...
 */
export enum CallMessage8Enum {
    ActivateRevenueShare = "activate_revenue_share",
    DeactivateRevenueShare = "deactivate_revenue_share",
}
...
export interface CallMessage3Register {
    /**
...
export interface CallMessage12 {
    set_value: number;
}

export interface CallMessage13 {
...
export enum CallMessage14 {
    NoOp = "no_op",
}

export interface CallMessage15 {
    submit_belief: SubmitBelief;
}

export interface SubmitBelief {
    belief_id: number;
    value:     number;
    [property: string]: any;
}
 ...
 * draining a warp route in case an exploit is discovered or validators are malicious.
 * Hyperlane uses "token bucket" algorithm for rate limitting. If rate limitting is not
 * desired, the parameters that control it can be set to [`Amount::MAX`].
 *
 ...
 */
export interface CallMessage11 {
    register?:                CallMessage11Register;
    update?:                  Update;
    enroll_remote_router?:    EnrollRemoteRouter;
    un_enroll_remote_router?: UnEnrollRemoteRouter;
...
export interface CallMessage11Register {
    /**
     * The authority that can modify the route, if any.
     */
    admin: AdminClass | AdminEnum;
    /**
     * Defines how many tokens are added to the inbound transferrable limit at each visible
     * slot.
     *
     * Usually this should be set to a value which allows full limit recovery each day, so
     * `transferrable_tokens_limit / DA_SLOTS_PER_DAY`.
     */
    inbound_limit_replenishment_per_slot: number;
    /**
     ...
     * current limit value until 0, at which point all new transfers are rejected. The limit
     * recovers at each visible slot by a configured amount.
     */
    inbound_transferrable_tokens_limit: number;
    /**
     * The ISM for this route.
     */
    ism: IsmClass | IsmEnum;
    /**
     * Defines how many tokens are added to the outbound transferrable limit at each visible
     * slot.
     *
     * Usually this should be set to a value which allows full limit recovery each day, so
     * `transferrable_tokens_limit / DA_SLOTS_PER_DAY`.
     */
    outbound_limit_replenishment_per_slot: number;
    /**
     ...
     * recovers at each visible slot by a configured amount.
     */
    outbound_transferrable_tokens_limit: number;
    /**
...
export interface Update {
     ...
     */
    admin?: AdminClass | AdminEnum | null;
    /**
     * Defines how many tokens are added to the inbound transferrable limit at each visible slot.
     */
    inbound_limit_replenishment_per_slot?: number | null;
    /**
     * Defines how many tokens can be transferred to the route without any refills.
     */
    inbound_transferrable_tokens_limit?: number | null;
    /**
     ...
     * slot.
     */
    outbound_limit_replenishment_per_slot?: number | null;
    /**
     * Defines how many tokens can be transferred from the route without any refills.
     */
    outbound_transferrable_tokens_limit?: number | null;
    /**
...
const typeMap: any = {
    "RuntimeCall": o([
        ...
        { json: "chain_state", js: "chain_state", typ: u(undefined, r("Event")) },
        { json: "blob_storage", js: "blob_storage", typ: u(undefined, null) },
        { json: "paymaster", js: "paymaster", typ: u(undefined, r("CallMessage7")) },
        { json: "revenue_share", js: "revenue_share", typ: u(undefined, u(r("CallMessage8Class"), r("CallMessage8Enum"))) },
        ...
        { json: "warp", js: "warp", typ: u(undefined, r("CallMessage11")) },
        { json: "value_setter", js: "value_setter", typ: u(undefined, r("CallMessage12")) },
        { json: "veritas_agent", js: "veritas_agent", typ: u(undefined, r("CallMessage13")) },
        { json: "veritas_belief", js: "veritas_belief", typ: u(undefined, r("CallMessage14")) },
        { json: "veritas_submission", js: "veritas_submission", typ: u(undefined, r("CallMessage15")) },
    ], false),
    "CallMessage": o([
    ...
    "UpdateAdmin": o([
        { json: "new_admin", js: "new_admin", typ: u(undefined, u(null, "")) },
        { json: "token_id", js: "token_id", typ: "" },
    ], "any"),
    "CallMessage10": o([
    ...
    "CallMessage8Class": o([
        { json: "lower_revenue_percentage", js: "lower_revenue_percentage", typ: u(undefined, r("LowerRevenuePercentage")) },
        { json: "update_sovereign_admin", js: "update_sovereign_admin", typ: u(undefined, r("UpdateSovereignAdmin")) },
        { json: "withdraw_rewards", js: "withdraw_rewards", typ: u(undefined, r("WithdrawRewards")) },
    ], false),
    "LowerRevenuePercentage": o([
        { json: "percentage_in_basis_points", js: "percentage_in_basis_points", typ: 0 },
    ], "any"),
    "UpdateSovereignAdmin": o([
        { json: "new_admin", js: "new_admin", typ: "" },
    ], "any"),
    "WithdrawRewards": o([
        { json: "token_id", js: "token_id", typ: "" },
    ], "any"),
    "CallMessage3": o([
        { json: "register", js: "register", typ: u(undefined, r("CallMessage3Register")) },
    ...
    "CallMessage13": o([
        { json: "register_agent", js: "register_agent", typ: u(undefined, r("RegisterAgent")) },
        { json: "add_stake", js: "add_stake", typ: u(undefined, r("AddStake")) },
        { json: "withdraw_stake", js: "withdraw_stake", typ: u(undefined, r("WithdrawStake")) },
    ], false),
    "AddStake": o([
        { json: "amount", js: "amount", typ: 0 },
    ], "any"),
    "RegisterAgent": o([
        { json: "initial_stake", js: "initial_stake", typ: 0 },
    ], "any"),
    "WithdrawStake": o([
        { json: "amount", js: "amount", typ: 0 },
    ], "any"),
    "CallMessage15": o([
        { json: "submit_belief", js: "submit_belief", typ: r("SubmitBelief") },
    ], false),
    "SubmitBelief": o([
        { json: "belief_id", js: "belief_id", typ: 0 },
        { json: "value", js: "value", typ: 0 },
    ], "any"),
    "CallMessage11": o([
        { json: "register", js: "register", typ: u(undefined, r("CallMessage11Register")) },
        { json: "update", js: "update", typ: u(undefined, r("Update")) },
        { json: "enroll_remote_router", js: "enroll_remote_router", typ: u(undefined, r("EnrollRemoteRouter")) },
        { json: "un_enroll_remote_router", js: "un_enroll_remote_router", typ: u(undefined, r("UnEnrollRemoteRouter")) },
        { json: "transfer_remote", js: "transfer_remote", typ: u(undefined, r("TransferRemote")) },
    ], false),
    ...
    "CallMessage11Register": o([
        { json: "admin", js: "admin", typ: u(r("AdminClass"), r("AdminEnum")) },
        { json: "inbound_limit_replenishment_per_slot", js: "inbound_limit_replenishment_per_slot", typ: 0 },
        { json: "inbound_transferrable_tokens_limit", js: "inbound_transferrable_tokens_limit", typ: 0 },
        { json: "ism", js: "ism", typ: u(r("IsmClass"), r("IsmEnum")) },
        { json: "outbound_limit_replenishment_per_slot", js: "outbound_limit_replenishment_per_slot", typ: 0 },
        { json: "outbound_transferrable_tokens_limit", js: "outbound_transferrable_tokens_limit", typ: 0 },
    ...
    "Update": o([
        { json: "admin", js: "admin", typ: u(undefined, u(r("AdminClass"), r("AdminEnum"), null)) },
        { json: "inbound_limit_replenishment_per_slot", js: "inbound_limit_replenishment_per_slot", typ: u(undefined, u(0, null)) },
        { json: "inbound_transferrable_tokens_limit", js: "inbound_transferrable_tokens_limit", typ: u(undefined, u(0, null)) },
        { json: "ism", js: "ism", typ: u(undefined, u(r("IsmIsmClass"), r("IsmEnum"), null)) },
        { json: "outbound_limit_replenishment_per_slot", js: "outbound_limit_replenishment_per_slot", typ: u(undefined, u(0, null)) },
        { json: "outbound_transferrable_tokens_limit", js: "outbound_transferrable_tokens_limit", typ: u(undefined, u(0, null)) },
        { json: "warp_route", js: "warp_route", typ: "" },
    ], "any"),
    "IsmIsmClass": o([
        { json: "TrustedRelayer", js: "TrustedRelayer", typ: u(undefined, r("TrustedRelayer")) },
